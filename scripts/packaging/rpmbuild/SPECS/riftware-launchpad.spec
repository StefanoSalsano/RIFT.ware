...
cp -p %{RIFT_ROOT}/scripts/packaging/services/%{name}/rwlp-stop.sh   %{buildroot}/%{DST_RIFT_ROOT}/.install/var/rift/services/%{name}/
...
#test -f /etc/sysconfig/rift-launchpad || echo 'LP_OPTS=""' >/etc/sysconfig/rift-launchpad
