...
class TestToAndFromXMLConversion(unittest.TestCase):
  ...
  def test_xml_api_for_listy_path(self):
    ...
    expected_resp_xml = """<company:company xmlns:company="http://riftio.com/ns/core/util/yangtools/tests/company"><company:employee><company:id>0</company:id><company:extra-curriculum><company:interest>sleeping</company:interest></company:extra-curriculum></company:employee></company:company>"""
