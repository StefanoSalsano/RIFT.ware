...
class RaTasklet(RaManifestObject):
    ...
    def _add_to_inventory(self, parent, manifest, known):
        ...
        if self.name not in known:
            ...
            c.component_type = rwvcs_types_pb2.YangEnum.ComponentType.RWTASKLET
...
class RaNativeProcess(RaManifestObject):
    ...
    def _add_to_inventory(self, parent, manifest, known):
        ...
        if self.name not in known:
            ...
            c = parent.add()
            c.component_name = "%s" % self.name
            c.component_type = rwvcs_types_pb2.YangEnum.ComponentType.PROC
...
class RaProc(RaManifestObject):
    ...
    def _add_to_inventory(self, parent, manifest, known):
        ...
        c.component_type = rwvcs_types_pb2.YangEnum.ComponentType.RWPROC
        if self.run_as is not None:
...
class RaVm(RaManifestObject):
    ...
    def _add_to_inventory(self, parent, manifest, known):
        ...
        c = parent.add()
        c.component_name = self.name
        c.component_type = rwvcs_types_pb2.YangEnum.ComponentType.RWVM
...
class RaCollection(RaManifestObject):
    ...
    def _add_to_inventory(self, parent, manifest, known):
        ...
        component.component_type = rwvcs_types_pb2.YangEnum.ComponentType.RWCOLLECTION
        ...
        for subcomponent in self.subcomponents:
            ...
            action.start.recovery_action = subcomponent.recovery_action
...
class ProtobufManifestConverter(object):
    ...
    def manifest_to_protobuf(self, manifest):
        ...
        """
        pb_manifest = rw_manifest_pb2.YangData.RwManifest.Manifest()
    ...
    def create_bootstrap_section(self, pb_manifest, manifest):
        ...
        for component in manifest.vm_bootstrap:
            ...
            c.config_ready = True
            c.recovery_action = core.RecoveryType.FAILCRITICAL.value
    ...
    def create_init_section(self, pb_manifest, manifest):
        ...
        # Add rwtrace field to init section
