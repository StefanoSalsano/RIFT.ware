 ...
 * a command. This hook will be changed when netconf api's are used. */
typedef rw_status_t (*rwcli_messaging_hook)(NetconfReq* req, NetconfRsp **rsp);
 ...
 *                    messaging.
 * @note This is currently for use with RW.MSG and might change when it is to be
 *       used with netconf client.
 */
