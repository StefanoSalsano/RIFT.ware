...
// Helper function until we switch from underscore to lodash
Utils.isArrayLike = function(value) {
    return  value != null &&
	        this.isLength(value.length) &&
		    !_.isFunction(value) &&
		    typeof value != 'string';
}
// Helper function until we switch from underscore to lodash
Utils.isObjectLike = function(value) {
...
Utils.isCollection = function(value) {
    // When we refactor to lodash, do this:
    //   return (_.isArrayLike(value) || isObjectLike(value);
