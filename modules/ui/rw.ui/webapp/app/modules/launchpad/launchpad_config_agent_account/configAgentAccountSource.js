...
var createConfigAgentAccountSource = {
  ...
  create: function() {
    ...
    return {
      ...
      success: createConfigAgentAccountActions.createSuccess,
      loading: createConfigAgentAccountActions.createLoading,
      error: createConfigAgentAccountActions.createFail
    }
  },
